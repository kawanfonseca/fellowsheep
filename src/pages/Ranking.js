...
const Ranking = () => {
  ...
  const handleLeaderboardChange = (leaderboardId) => {
    setSelectedLeaderboard(leaderboardId);
    setSearchTerm(''); // Limpar busca ao trocar leaderboard
  };
        ...
        <div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center'}}>
          <div>
            ...
            <select 
              ...
              onChange={(e) => handleLeaderboardChange(Number(e.target.value))}
              style={{
                padding: '0.5rem',
                borderRadius: '8px',
            ...
            <table style={{width: '100%', borderCollapse: 'collapse', marginTop: '1rem'}}>
              <thead>
                <tr style={{borderBottom: '2px solid #d4af37'}}>
                  ...
                  <th style={{padding: '1rem', textAlign: 'center', color: '#d4af37'}}>Streak</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{padding: '1rem', color: '#e0e0e0', fontWeight: 'bold'}}>
                        ...
                        {player.country && <span style={{color: '#888', marginLeft: '0.5rem'}}>🌍</span>}
                      </td>
                      ...
                      <td style={{padding: '1rem', textAlign: 'center', color: player.streak > 0 ? '#6bcf7f' : player.streak < 0 ? '#ff6b6b' : '#e0e0e0'}}>
              ...
              {rankingData.fsPlayers.slice(0, 3).map((player, index) => {
                ...
                return (
                  <p key={index}>
                    ...
                    {t('ranking.games')}: {totalGames || 'N/A'}{" | "}
                    {t('ranking.winrate')}: {winRate}%{" | "}
                    Streak: {player.streak > 0 ? `+${player.streak}` : player.streak || '0'}
                  </p>
                );
              })}
            </div>
